...
INSERT INTO customer_details (first_name, last_name, email)
VALUES ('Niranjan', 'Reddy', 'reddy.gaaru@example.com');

DELETE FROM customer_details WHERE first_name = 'Niranjan';


SELECT * FROM customer_details_stream WHERE METADATA$ACTION = 'DELETE';
...
-- Delete a row
DELETE FROM customer_details WHERE first_name = 'Michael';

-- Check the stream for delete actions
SELECT * FROM customer_details_stream WHERE METADATA$ACTION = 'DELETE';

-- Check the stream for all changes
SELECT * FROM customer_details_stream;
